# -*- coding: utf-8 -*-
"""
Created on Tue Aug 16 21:45:23 2022
...
#
# In this example we show how to manage different biomass stocks with 
##different potentials and costs, carbon dioxide hydrogenation from biogas,
## direct air capture (DAC) and carbon capture and usage/sequestration/cycling (CCU/S/C).
#
# Demand for electricity and diesel transport have to be met from various biomass sources, 
##natural gas with possibility for carbon capture, electrolysis for hydrogen production,
## direct air capture of CO2, and diesel synthesis via Fischer-Tropsch.
#
...
"""
First tell PyPSA that links can have multiple outputs by overriding the component_attrs. 
This can be done for as many buses as you need with format busi for i = 2,3,4,5,….
"""
